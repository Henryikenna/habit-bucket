  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        // onRefresh: () async => ref.invalidate(habitStreaksProvider),
        onRefresh: () async {
          final range = ref.read(selectedStatsRangeProvider);

          await Future.wait([
            ref.refresh(dashboardStatsProvider(range).future),
            ref.refresh(statsAggregatesProvider(range).future),
            ref.refresh(habitStreaksProvider.future),
